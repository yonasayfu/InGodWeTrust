...
// Define props to receive the bank form data
...
// Initialize the form with the existing bank form data
const form = useForm({
  bank_name: props.bankForm.bank_name,
  form_name: props.bankForm.form_name,
  form_file: null as File | null, // Assuming form_file is for new uploads
  _method: 'PUT', // Add this line to specify the HTTP method
});
...
const submit = () => {
  form.post(route('bank-forms.update', props.bankForm.id), {
    preserveScroll: true,
    onSuccess: () => {
      form.reset();
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6">
      <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-3xl font-bold">Edit Bank Form</h1>
      </div>
